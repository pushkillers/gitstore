...
export function DeveloperCard({ developer, showRank = false }: DeveloperCardProps) {
      ...
      <div className="relative h-48 bg-gradient-to-br from-[#1f6feb]/20 to-[#8b5cf6]/20 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative group/avatar">
            ...
            <div className="relative w-20 h-20 rounded-full bg-gradient-to-br from-[#1f6feb] via-[#6366f1] to-[#8b5cf6] border-2 border-[#30363d] flex items-center justify-center text-4xl font-bold text-white shadow-2xl ring-2 ring-[#1f6feb]/20 group-hover/avatar:ring-[#1f6feb]/40 transition-all">
              {developer.avatar}
            </div>
